...
final class PaymentControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        ...
        $fixture->setMethode('My Title');
        $fixture->setStatus('My Title');
        $fixture->setCreatedAt('My Title');
        $fixture->setBooking('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setMethode('Value');
        $fixture->setStatus('Value');
        $fixture->setCreatedAt('Value');
        $fixture->setBooking('Value');
        ...
        self::assertSame('Something New', $fixture[0]->getMethode());
        self::assertSame('Something New', $fixture[0]->getStatus());
        self::assertSame('Something New', $fixture[0]->getCreatedAt());
        self::assertSame('Something New', $fixture[0]->getBooking());
    }
